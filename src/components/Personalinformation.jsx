    ...
    <div style={{ width: "100%" }}>
      ...
      <Section title="CONTACT">
        <div style={{ marginBottom: 12 }}>
          ...
          >
            <PhoneOutlined
              style={{ color: "#2c3e50", fontSize: "12px", marginTop: 2 }}
            />
            <span style={{ color: "#34495e", fontSize: "12px", flex: 1 }}>
              {contact.phone}
            </span>
          </div>
          <div
      ...
      <Section title="EDUCATION">
        <div>
          {edu.school && (
            <div
              style={{ fontSize: "11px", color: "#34495e", marginBottom: 2 }}
            >
              {edu.school}
            </div>
          )}
          ...
          {edu.gpa && (
            <div style={{ fontSize: "11px", color: "#34495e" }}>
              GPA: {edu.gpa}
            </div>
          )}
        </div>
